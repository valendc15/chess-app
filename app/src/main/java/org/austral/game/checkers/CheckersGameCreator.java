...
public class CheckersGameCreator {

    public static CheckersGame createGame() {
        ...
        CompositeOrValidator whitePieceMovements = CheckersValidMovementsCreator.createNormalWhitePieceMovements();
        CompositeOrValidator blackPieceMovements = CheckersValidMovementsCreator.createNormalBlackPieceMovements();
